                ...
                <Segment>
                    ...
                    <div className="column">
                        <Img className="avatar-img"
                             src="https://www.shareicon.net/download/2015/09/18/103157_man_512x512.png"
                             alt='avatar'/>
                        <span><h4>Front-End Developer <p>Front-End Developer</p></h4> I'm the Front-End Developer. I have serious passion for UI effects and creating intuitive, dynamic user experiences </span>
                    </div>
                    <div className="column">
                        <Skills
                            skill="HTML/CSS"
